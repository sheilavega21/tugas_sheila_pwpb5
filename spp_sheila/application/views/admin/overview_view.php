                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url("assets/images/icon/ava_jaehyun.jpg")?>" />
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                   <img src="<?php echo base_url("assets/images/icon/ava_haechan.jpg")?>" />
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                         <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo base_url('assets/CoolAdmin-master/images/icon/ava_pajri.jpg')?>" alt="ppjrre" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Pajri Romdhoni</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                       <img src="<?php echo base_url('assets/CoolAdmin-master/images/icon/ava_pajri.jpg')?>" alt="pppjrre" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Pajri Romdhoni Isyana</a>
                                                    </h5>
                                                    <span class="email">romdhonipajri@gmail.com</span>
                                                </div>
                                            </div>
